<script>
  ...
  import { showOverlay, videoId } from "../stores/youtube"
...
<BasePage>
  <h1>{$t.privacy}</h1>
  <button class="btn-close | rounded" on:click={() => pop()}>{$t.goBack}</button
  >
  ...
  <p>E-Mail: kontakt@rostling.de</p>
  <p>
  ...
  <p>
    ...
    diesen L&auml;ndern kein mit der EU vergleichbares Datenschutzniveau
  ...
  <p>
    ...
    an. Sie werden entweder vor&uuml;bergehend f&uuml;r die Dauer einer Sitzung
  ...
  <p>
    ...
    erw&uuml;nschter Funktionen (z.&nbsp;B. f&uuml;r die Warenkorbfunktion) oder
    ...
    ausschlie&szlig;lich auf Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a
    DSGVO und &sect; 25 Abs. 1 TTDSG); die Einwilligung ist jederzeit
    widerrufbar.
  </p>
  <p>
  ...
  <p>
    ...
    Google Ireland Limited (&bdquo;Google&ldquo;), Gordon House, Barrow Street,
    Dublin 4, Irland.
  </p>
  <p>
    Wir nutzen YouTube im erweiterten Datenschutzmodus. Dieser Modus bewirkt
    laut YouTube, dass YouTube keine Informationen &uuml;ber die Besucher auf
    ...
    hingegen nicht zwingend ausgeschlossen. So stellt YouTube &ndash;
    unabh&auml;ngig davon, ob Sie sich ein Video ansehen &ndash; eine Verbindung
    zum Google DoubleClick-Netzwerk her.
  </p>
  <p>
    ...
    in Ihrem YouTube-Account eingeloggt sind, erm&ouml;glichen Sie YouTube, Ihr
    Surfverhalten direkt Ihrem pers&ouml;nlichen Profil zuzuordnen. Dies
    k&ouml;nnen Sie verhindern, indem Sie sich aus Ihrem YouTube-Account
    ausloggen.
  </p>
  <p>
    Des Weiteren kann YouTube nach Starten eines Videos verschiedene Cookies auf
    Ihrem Endger&auml;t speichern oder vergleichbare
    Wiedererkennungstechnologien (z.&nbsp;B. Device-Fingerprinting) einsetzen.
    Auf diese Weise kann YouTube Informationen &uuml;ber Besucher dieser Website
  ...
  <p>
    ...
    von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die
    Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen
    im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des
  ...
  <p>
    Quelle: <a class="link" href="https://www.e-recht24.de"
